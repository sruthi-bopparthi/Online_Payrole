<%-- 
    Document   : UpdateHousingSuccess
    Created on : 21 Mar, 2019, 1:09:30 PM
    Author     : sruth
--%>
...
<html>
    ...
    <body>
         <%
            ...
            String sql = "update empsal set Housing_Loan=? where Emp_ID=?";
            ...
            String md=""+request.getParameter("t2");
               ...
               if(i>0)
               {
                ...
                out.println("<br>");
                out.println("Housing Loan has been updated succesfully!");
                out.println("<br>");
                out.println("<br>");
